          ...
          <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            <div className="flex justify-center space-x-6 md:order-2">
              <a href="https://github.com/Shikachuu/shrtn.hu" className="text-d-text dark:text-text">
                ...
                <svg className="h-6 w-6 text-d-text dark:text-text" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
              <p className="text-center text-base text-d-text dark:text-text">
                shrtn.hu is built by <a href="https://github.com/Shikachuu">Máté</a> with a lot of ☕ using <a href="https://github.com/Shikachuu/shrtn.hu/blob/main/LICENSE">The Unlicense</a>
              </p>
            </div>
          </div>
        </footer>
